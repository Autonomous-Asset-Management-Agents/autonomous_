...
def require_engine_key(
    ...
    x_engine_key: Optional[str] = Header(None, alias="X-Engine-Key"),
) -> None:
    """
...
def verify_user_id_sig(
    ...
    x_user_id_sig: Optional[str] = Header(None, alias="X-User-Id-Sig"),
    x_user_id_ts: Optional[str] = Header(None, alias="X-User-Id-Ts"),
) -> None:
    """
