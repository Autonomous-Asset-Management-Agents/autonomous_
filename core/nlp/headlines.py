...
#     NOTE (#2632): the flag now defaults to **True** in both editions
#     (settings.py::NEWS_SENTIMENT_NLP_ENABLED — seit #3553 eine Quelle) — this header
#     said "off (default)" long after the rollout, which
