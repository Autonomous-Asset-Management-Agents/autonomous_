...
# Era env market feature order — trading_environment.py, Zeilen 53-56 der
# Code-Aera jan2026 (nicht im Repository).
...
# Era v3 volatility regime thresholds — trading_environment.py, Zeile 71 der
# Code-Aera jan2026 (nicht im Repository).
