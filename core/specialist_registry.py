...
def _should_preserve_existing(
    existing: SpecialistReport, incoming: SpecialistReport
) -> bool:
    """Return True if an existing rich report should be preserved over an incoming degraded report."""
    ...
    async def _refresh_symbol(self, symbol: str) -> None:
        ...
        try:
            ...
            with self._lock:
                ...
                if existing and _should_preserve_existing(existing, report):
                    logger.warning(
