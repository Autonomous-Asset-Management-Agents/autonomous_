...
def init_telemetry(service_name: str = "aaa-backend") -> None:
    ...
    try:
        ...
        resource = Resource.create(
            {
                ...
                "environment": "cloud" if root.is_cloud else "local",
            }
        )
        ...
        if root.is_cloud and not _in_ci and _CLOUD_TRACE_AVAILABLE:
            try:
