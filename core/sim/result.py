...
class SimResult:
    ...
    # #2956/#3038 — True, wenn die Engine den Lauf angehalten hat (Kill-Switch,
    # Shutdown), statt das Fenster zu Ende zu spielen. BEWUSST getrennt von
    # ``timed_out``: Der Lauf ist nicht an der Zeit gescheitert, sondern die Engine
    # hat abgeschaltet. Wer beide Ursachen nicht unterscheiden kann, sucht den
    # Fehler an der falschen Stelle. Die replayten Tage bis hierhin sind gueltig —
    # ein Vergleich gegen einen vollstaendigen Lauf ist es nicht.
    halted: bool = False
    halt_reason: str = ""
