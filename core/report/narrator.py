...
and the sanctioned providers decode at temperature 0.0). Report-only:
nothing here is read by the decision path. (The SpecialistAlphaAgent's *score* does
vote — ``SPECIALIST_ALPHA_WEIGHT`` defaults to 0.40 since #2839; #3261.)
"""
