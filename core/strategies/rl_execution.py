...
class RLExecutionMixin:
    ...
    def _check_smart_exit(
        ...
        if decision.action == "SELL":
            ...
            # Legacy rule-based exit carries no tier → treat as 'risk' (never gated):
            # fail-safe, preserves today's behaviour for the fallback path.
            return {"triggered": True, "signal": "SELL", "tier": "risk"}
        return {"triggered": False, "signal": "HOLD"}
