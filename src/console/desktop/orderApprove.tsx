    ...
    return (
      <span className="inline-flex items-center gap-2">
        <button
          ...
          className="text-[11px] font-semibold text-[#00c27a] hover:underline disabled:opacity-50"
        >
        ...
        {state === "error" && <span className="text-[10px] text-[#ffb4af]">approve failed — retry</span>}
      </span>
    );
  }
  return (
  ...
  if (state === "armed" || state === "error") {
    return (
      <span className="inline-flex items-center gap-2">
        ...
        {state === "error" && <span className="text-[10px] text-[#ffb4af]">reject failed — retry</span>}
      </span>
    );
  }
  return (
