...
export function BrokerKeysCard({ mode = "paper" }: { mode?: "paper" | "live" }) {
  ...
  return (
    <div className={`surface p-6 ${isLive ? "border border-[#ff453a]/30" : ""}`}>
      <div className="eyebrow mb-2">{isLive ? "⚠ Live Alpaca keys" : "Broker API keys (Paper)"}</div>
