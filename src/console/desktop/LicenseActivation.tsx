 ...
 * idioms (.btn family per UXC-1 S8 #3177 — no solid green outside critical flows; no gold/amber).
 */
export function LicenseActivation({
  ...
  const noteClass =
    note?.tone === "ok" ? "text-[#00c27a]" : note?.tone === "err" ? "text-[#ffb4af]" : "text-white/55";
  ...
  return (
    <div className="mt-3 rounded-xl border border-white/10 bg-[#00c27a]/[0.04] p-4">
      ...
      <textarea
        ...
        spellCheck={false}
        className="w-full min-h-[80px] resize-y rounded-lg border border-white/10 bg-black/40 p-2.5 font-mono text-[11px] leading-relaxed text-white/85 placeholder:text-white/25 outline-none"
      />
