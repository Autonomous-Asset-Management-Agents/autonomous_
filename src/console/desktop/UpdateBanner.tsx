 ...
 * green is used only on the passive status dot and the version; the Download action is a
 * standard .btn (UXC-1 S8, #3177 — no solid green outside critical flows).
 */
    ...
    >
      ...
      {status.downloadUrl && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="btn btn-compact shrink-0"
        >
          Download
        </a>
      )}
