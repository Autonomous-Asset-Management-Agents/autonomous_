...
import { filterCurveByRange, rangeReturnCashflowAdjusted, changeTone, rangeWindowLabel, EQUITY_RANGES, type EquityRange } from "@/console/live/equityRange";
        ...
        <div className="grid grid-cols-[1fr_auto] gap-6 items-start relative">
          <div>
            ...
            <div className="flex items-baseline gap-4 flex-wrap">
              ...
              {rangeChange != null && (
                <div className={`flex items-baseline gap-3 ${changeTone(rangeChange) === "bull" ? "text-bull" : "text-bear"}`}>
                  <span className="num text-[20px] font-semibold">{money(rangeChange.abs, { sign: true })}</span>
                  <span className="num text-[14px]">{fmtPct(rangeChange.pct)} {rangeLabel}</span>
                </div>
              )}
            </div>
      ...
      <div className="grid grid-cols-[1.15fr_1fr] gap-5">
        <div className="surface p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={() => setDesktopPage("decisions")} className="btn-link">
              View all <IconChevronRight width={10} height={10} />
            </button>
          </div>
        ...
        <div className="surface p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={() => setDesktopPage("positions")} className="btn-link">
              View all <IconChevronRight width={10} height={10} />
            </button>
          </div>
