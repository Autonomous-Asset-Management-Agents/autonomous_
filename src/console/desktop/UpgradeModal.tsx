 ...
 * Only Senior is claimable in-app; the other two are contact/link CTAs. Design: fixed scrim +
 * surface card; actions use the .btn family (UXC-1 S8, #3177 — solid green stays critical-only).
 */
...
export function UpgradeModal({ onClose, refetch }: { onClose: () => void; refetch: () => Promise<void> }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4" onClick={onClose}>
      <div
        className="surface p-6 w-full max-w-3xl max-h-[88vh] overflow-y-auto"
        ...
        <div className="flex items-start justify-between gap-4 mb-1">
          <div>
            ...
            <div className="mt-1.5">
              <span className="pill">You&apos;re on {isSenior ? "Senior" : "Junior"}</span>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="flex flex-col rounded-xl border border-white/20 bg-white/[0.05] p-4">
            <div className="flex items-center justify-between">
              ...
              <span className="pill">{isSenior ? "your plan" : "recommended"}</span>
            </div>
            ...
            {isSenior ? (
              ...
              <>
                ...
                <button
                  ...
                  className="btn-link mt-2 w-full justify-center"
                >
