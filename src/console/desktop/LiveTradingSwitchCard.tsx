 ...
 * the honest state line. The Paper/Live key slots moved to the System tab (#2863) so the
 * Trading tab stays about trading behaviour — see TradingKeysCard.
 *
  ...
  if (allowLive === false) {
    ...
    return (
      <div className="surface p-6">
        ...
        {/* Trading-Schlüssel moved to the System tab (#2863) — Trading stays trading-focused. */}
