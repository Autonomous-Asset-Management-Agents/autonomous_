...
export function adaptOne(r: SpecialistReportDTO): SpecialistReport {
...
/** REPORTS-UX Wave 1 (#2710): adapt ONE full report (GET /specialist-report/{symbol}). */
export function adaptSpecialistReport(
  dto: SpecialistReportDTO | null | undefined,
): SpecialistReport | null {
  return dto ? adaptOne(dto) : null;
}
