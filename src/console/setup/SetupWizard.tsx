        ...
        {step === "welcome" && (
          <>
            <div>
              ...
              <h1 className="text-[22px] font-bold tracking-tight2 text-white/92">Set up AAAgents</h1>
        ...
        {step === "alpaca" && (
          <>
            <div>
              ...
              <p className="text-white/55 text-[12.5px] mt-2">
                Paper-trading API keys from your Alpaca dashboard. Stored in your OS keychain — never on disk.
              </p>
            </div>
            <label className="block text-[12px] text-white/55">
              API key ID
        ...
        {step === "finish" && (
          <>
            ...
            <button onClick={() => void finish()} disabled={busy} className={PRIMARY}>
              {busy ? "Launching…" : "Launch AAAgents"}
            </button>
          </>
        )}
      </div>
