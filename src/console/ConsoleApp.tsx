    ...
    <div className="aaa-console h-screen w-screen overflow-hidden">
      {!checked ? null : showWizard ? (
        ...
        <div className="relative h-full w-full">
          {needsSetup && demoMode ? (
            <div className="absolute top-0 inset-x-0 z-50 flex items-center justify-between gap-3 px-4 py-1.5 text-[12px] bg-[#00c27a]/12 border-b border-[#00c27a]/25 text-[#7ce7b3]">
