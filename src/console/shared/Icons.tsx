...
export const IconBrandApple = (p: SVGProps<SVGSVGElement>) => (
  <I {...p}><path d="M16.7 12.9c0-2.1 1.7-3.1 1.8-3.2-1-1.4-2.5-1.6-3-1.6-1.3-.1-2.5.75-3.2.75-.7 0-1.7-.73-2.8-.71-1.4 0-2.8.84-3.5 2.1-1.5 2.6-.4 6.5 1.1 8.6.7 1 1.6 2.2 2.7 2.1 1.1 0 1.5-.7 2.8-.7s1.7.7 2.8.68c1.2 0 1.9-1 2.6-2.1.8-1.2 1.2-2.4 1.2-2.4s-2.4-.9-2.5-3.5zM14.6 6.1c.6-.7 1-1.7.9-2.7-.9 0-1.9.6-2.5 1.3-.6.6-1 1.6-.9 2.6 1 .1 2-.5 2.5-1.2z" fill="currentColor" stroke="none" /></I>
);
