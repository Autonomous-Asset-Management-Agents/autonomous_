                  ...
                  <div key={d.symbol} className="p-3 rounded-lg bg-white/[0.025] border border-white/5">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="min-w-0">
                        <span className="block font-bold text-[13px] tracking-tight2 text-white/92 truncate">{d.symbol}</span>
                        {name && (
                          <span className="block text-[10px] font-normal text-white/40 truncate leading-tight">{name}</span>
                        )}
                      </span>
                ...
                return (
                  <div key={p.symbol} className="flex items-center gap-3 py-2.5 border-b border-white/5 last:border-0">
                    <div className="w-24 min-w-0">
                      <span className="block font-bold text-[13px] tracking-tight2 text-white/92 truncate">{p.symbol}</span>
                      {name && (
                        <span className="block text-[10px] font-normal text-white/40 truncate leading-tight">{name}</span>
                      )}
                    </div>
