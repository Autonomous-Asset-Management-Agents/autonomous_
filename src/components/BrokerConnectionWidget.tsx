            ...
            <CardHeader className="p-4 sm:p-6 pb-2">
                <div className="flex items-center justify-between">
                    ...
                    {isConnected ? (
                        ...
                        <div className="flex items-center gap-2 text-white/90 bg-white/[0.06] px-3 py-1.5 rounded-full border border-white/15">
                ...
                {isConnected ? (
                    ...
                    <div className="flex flex-col gap-4 bg-muted/30 p-4 rounded-lg border border-border/50">
                        ...
                        <div className="bg-background border border-border rounded-md p-3 font-mono text-xs text-muted-foreground">
                            ...
                            <div>ALPACA_API_KEY=<span className="text-white/80">your_paper_key</span></div>
                            <div>ALPACA_SECRET_KEY=<span className="text-white/80">your_paper_secret</span></div>
