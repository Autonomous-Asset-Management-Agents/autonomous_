...
/**
 * Canonical site header — ONE shared nav (logo + LinkedIn + GitHub + Login + Demo) used by the
...
export function SiteHeader({ dark = false }: { dark?: boolean } = {}) {
  ...
  async function login() {
    try {
      ...
      toast.error(`Login fehlgeschlagen (${code || "unbekannt"}).`);
    }
  }
