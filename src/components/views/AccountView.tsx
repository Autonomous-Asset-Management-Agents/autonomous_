...
export const AccountView = () => {
  ...
  const sectionTitle = (label: string) => (
    <div style={{ fontSize: 12, fontWeight: 600, color: "#ffffff", textTransform: "uppercase", letterSpacing: "0.05em", padding: "14px 0 8px" }}>
      {label}
    </div>
  );
  ...
  const linkStyle: React.CSSProperties = { ...valStyle, color: "#ffffff", cursor: "pointer" };
