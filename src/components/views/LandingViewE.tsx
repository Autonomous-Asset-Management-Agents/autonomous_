                    ...
                    <div className="lb-ticker-track">
                        ...
                        {[0, 1].map((i) => (
                            <span key={i} className="lb-ticker-item" aria-hidden={i === 1 ? "true" : undefined}>
                                Open Source Version launched - download from github
                                &nbsp;&nbsp;&nbsp;·&nbsp;&nbsp;&nbsp;
                                Open Source Version launched - download from github
                                &nbsp;&nbsp;&nbsp;·&nbsp;&nbsp;&nbsp;
                            </span>
                        ...
                        <div className="lb-hero-grid">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                        ...
                                        <div className="hero-cta-group" style={{ marginTop: "16px", display: "flex", gap: "12px", alignItems: "center" }}>
                                            <a className="tr-btn-primary hero-btn-start" href="#block-editions" style={{ textDecoration: 'none' }}>
                                                Download on GitHub
                                            </a>
                                            <a
                                                className="lb-cta-social"
                            ...
                            >
                                ...
                                {logoOpacity > 0 && (
                                    ...
                                    >
                                        <div className="aaa-console-logo font-bold tracking-tight text-white select-none leading-none">
                                        ...
                                        <div className="flex-grow overflow-y-auto p-4 space-y-4 bg-black select-none">
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-4 mt-2 text-[9px] text-white/55">
                                                    ...
                                                    <span className="flex items-center gap-1.5"><span className="w-2.5 h-[1px] border-t border-dashed" style={{ borderColor: "rgba(212,168,83,0.6)" }} /> S&amp;P 500</span>
                                                </div>
                                            </div>
                ...
                <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
                    ...
                    <div className="ed-compare-container">
                        ...
                        <div className="ed-tiers" aria-label="autonomous_ vs Enterprise">
                            <article className="ed-tier ed-tier-private ed-tier-wide" style={{ gap: 0 }}>
                                <header className="ed-tier-head" style={{ minHeight: 'auto', paddingBottom: 0, borderBottom: 'none' }}>
                                    <span className="ed-tier-eyebrow">Desktop Version</span>
                                    <h3 className="ed-tier-name">Private Edition</h3>
                                </header>
                                
                                <div className="ed-tier-wide-content" style={{ marginTop: '12px' }}>
                                    <div className="ed-tier-wide-left">
                                        <p className="ed-tier-tag">
                                            The easiest way to get started with <b>autonomous<span style={{ color: "var(--lb-accent, #00c27a)" }}>_</span></b> trading. Designed for private individuals looking to discover AI-driven trading, this edition runs as a completely autonomous local installation. All your data, keys, and strategies remain strictly on your own computer.
                                        </p>
                                    </div>
                                    <div className="ed-tier-wide-right">
                                        <ul className="ed-feat-list">
                                            <li>
                                                <strong>Zero Configuration</strong>
                                                <span>A lightweight Electron app with a local SQLite database. Simply connect your <a href="https://alpaca.markets" target="_blank" rel="noopener noreferrer" style={{textDecoration: 'underline', color: 'inherit'}}>Alpaca trading account</a> and launch your first AI agent in minutes.</span>
                                            </li>
                                            <li>
                                                <strong>100% Local &amp; Private</strong>
                                                <span>Your strategies, keys, and trading history never leave your machine. Maximum privacy for your personal portfolio.</span>
                                            </li>
                                            <li>
                                                <strong>Free &amp; Open Source</strong>
                                                <span>Completely free to use with no subscriptions. The perfect entry point into the <b>autonomous<span style={{ color: "var(--lb-accent, #00c27a)" }}>_</span></b> ecosystem.</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                
                                <div className="ed-tier-wide-actions" style={{ marginTop: '64px' }}>
                                    <a className="ed-cta ed-cta-download"
                                       href="https://github.com/Autonomous-Asset-Management-Agents/autonomous_/releases/download/desktop-v0.1.3-beta/autonomous_setup.exe"
                                       target="_blank"
                                       rel="noopener noreferrer" style={{flex: 1}}>
                                        <svg viewBox="0 0 24 24" width="20" height="20" aria-hidden="true" style={{marginRight: 8}}>
                                            <path fill="currentColor" d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-13.051-1.801"/>
                                        </svg>
                                        <span>Download for Windows</span>
                                    </a>
                                    <button className="ed-cta ed-cta-download disabled-cta" disabled style={{flex: 1}}>
                                        <svg viewBox="0 0 24 24" width="20" height="20" aria-hidden="true" style={{marginRight: 8}}>
                                            <path fill="currentColor" d="M17.05 13.92c-.02-2.82 2.3-4.17 2.4-4.22-1.32-1.92-3.37-2.18-4.1-2.22-1.74-.18-3.4.1-4.3.1-.88 0-2.25-1.12-3.7-1.12-1.9 0-3.66 1.1-4.63 2.78-1.98 3.42-.5 8.47 1.43 11.27.94 1.36 2.05 2.9 3.53 2.85 1.43-.05 1.98-.92 3.7-.92 1.7 0 2.22.92 3.73.9 1.53-.02 2.5-1.4 3.4-2.77 1.05-1.54 1.48-3.03 1.5-3.1-.03-.02-2.87-1.1-2.9-4.55M14.94 4.54c.78-.96 1.3-2.3 1.16-3.64-1.15.05-2.55.77-3.35 1.73-.7.83-1.3 2.18-1.13 3.5 1.3.1 2.55-.63 3.32-1.59z"/>
                                        </svg>
                                        <span>Coming soon: Mac</span>
                                    </button>
                                </div>
                            </article>
                            ...
                            <article className="ed-tier ed-tier-oss">
                                <header className="ed-tier-head">
                                    <span className="ed-tier-eyebrow">Docker First Architecture</span>
                                    <h3 className="ed-tier-name">Developer Edition</h3>
                                    <p className="ed-tier-tag">
                                ...
                                <div className="ed-tier-body">
                                    <ul className="ed-feat-list">
                                        ...
                                        <li>
                                            ...
                                            <span>Built-in paper trading and Alpaca integration for safe, zero-risk strategy testing with your own API credentials.</span>
                                        </li>
                                    </ul>
                                    <a className="ed-cta"
                                       href="https://github.com/Autonomous-Asset-Management-Agents/autonomous_"
                            ...
                            <article className="ed-tier ed-tier-ent">
                                <header className="ed-tier-head">
                                    <span className="ed-tier-eyebrow">Cloud Native Architecture</span>
                                    <h3 className="ed-tier-name">Enterprise Edition</h3>
                                    <p className="ed-tier-tag">
