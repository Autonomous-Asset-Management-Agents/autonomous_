                    ...
                    <div className="lb-ticker-track">
                        ...
                        {[0, 1].map((i) => (
                            <span key={i} className="lb-ticker-item" aria-hidden={i === 1 ? "true" : undefined}>
                                autonomous_ desktop trader available - download for windows
                                &nbsp;&nbsp;&nbsp;·&nbsp;&nbsp;&nbsp;
                                autonomous_ desktop trader available - download for windows
                                &nbsp;&nbsp;&nbsp;·&nbsp;&nbsp;&nbsp;
                            </span>
                ...
                <div className="tr-grid">
                    ...
                    <div className="tr-text">
                        ...
                        <p className="tr-intro">
                            <b>autonomous<span style={{ color: "var(--lb-accent, #00c27a)" }}>_</span></b> outperforms because every motion runs through watchlist
                            specialized machine learning models, a nine-agent consensus-driven voting framework (Round Table V2), and
                ...
                <div id="block-editions" style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
                    ...
                    <div className="ed-tiers" style={{ 
                      ...
                      gap: '24px' 
                        ...
                        <PricingCard tier={pricingData.private} mode={pricingMode} setMode={setPricingMode} />
                        <PricingCard tier={pricingData.professional} isProfessional />
                        <PricingCard tier={pricingData.institutional} isInstitutional />
                    </div>

                    <div className="ed-foot" style={{ marginTop: '64px' }}>
            ...
            >
                ...
                <div className="overlay-content">
                    <div className="overlay-inner">
                        ...
                        <h1>Nine perspectives.<br />One sized signal.</h1>
                        <p className="lede-big">
                            No single model decides. Nine voting agents each carry a fixed
