                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                {/* EU AI Act Art. 50 — AI-interaction transparency (GTM-1 T5) */}
                                <p style={{ fontSize: 10, opacity: 0.45, marginTop: 8, lineHeight: 1.4 }}>
                                    You are interacting with an AI system. Responses are AI-generated, not investment advice.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="tr-grid">
                    ...
                    <div className="tr-text">
                        ...
                        <p className="tr-intro">
                            <b>aaagents_</b> outperforms because every motion runs through watchlist
