...
describe("Settings → System · Update card", () => {
  ...
  it("mac line (#2853): the DMG url renders as a Download link that opens externally, never an Install control", async () => {
    // Same contract as the banner: the shell only reports the DMG url of the desktop-mac-v*
    // release; the card opens it in the browser (setWindowOpenHandler → shell.openExternal).
