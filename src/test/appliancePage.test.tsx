...
describe("Appliance page (spec §7a)", () => {
  it("renders the approved copy spine: H1, price, edition, CTA, section heads", () => {
    ...
    // price display (operator 30.08.): no numeric price on public pages — "Price on request"
    expect(screen.getAllByText(/Price on request/).length).toBeGreaterThanOrEqual(2); // hero + spec sheet
