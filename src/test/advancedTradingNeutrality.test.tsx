...
describe("Advanced trading neutrality (UXC-1 S5)", () => {
  ...
  it("N3: the field table matches the seven-group plan scope (20 editable fields)", () => {
    expect(ADVANCED_GROUPS).toHaveLength(7);
    expect(ADVANCED_KEYS).toHaveLength(20);
    expect(new Set(ADVANCED_KEYS).size).toBe(20);
  });
});
