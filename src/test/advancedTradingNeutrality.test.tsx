...
describe("Advanced trading neutrality (UXC-1 S5)", () => {
  ...
  it("N3: the field table matches the eight-group plan scope (23 editable fields; #3199 skew tilt moved to the Agents sizing stage, #3210 coverage sizing here, #3220/#3221 order and trade limits added)", () => {
    expect(ADVANCED_GROUPS).toHaveLength(8);
    expect(ADVANCED_KEYS).toHaveLength(23);
    expect(new Set(ADVANCED_KEYS).size).toBe(23);
  });
});
