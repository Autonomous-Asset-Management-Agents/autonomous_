...
const gotoSettings = () => fireEvent.click(screen.getByRole("button", { name: /settings/i }));
...
describe("Journey · Settings (engine lifecycle & safety)", () => {
  ...
  it("shows the seeded status and replays the engine log on open", async () => {
    ...
    await waitFor(() => expect(screen.getByRole("heading", { name: /engine, broker & safety/i })).toBeTruthy());
