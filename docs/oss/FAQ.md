...
It ships a consensus framework (Round Table V2) of 9 specialized agents incorporating LSTM, PPO (Reinforcement Learning), and heuristic specialist/compliance voters. You can **bring your own models** — drop in your own classifiers, signal generators, or a private LLM as first-class voters. No vendor lock-in.
