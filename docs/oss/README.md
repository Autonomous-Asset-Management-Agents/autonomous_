...
| Alpaca + `GEMINI_API_KEY` | **Full Sentiment Mode** — activates the `NewsSentimentAgent` (`agents.py#L605`). Without it, the bot runs in **Degraded Sentiment Mode** (8/9 agents active — `NewsSentimentAgent` votes with weight 0). |
