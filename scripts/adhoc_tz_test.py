...
def main():
    # #612: no user path in committed code — the desktop app folder differs per machine.
    ...
    data_dir = os.path.join(app_dir, "market_data_cache")
    model_dir = os.path.join(app_dir, "data")
