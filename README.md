...
This table shows the **deployment** differences across the **Desktop Edition**, **OSS Self-Hosted Edition**, and the **Enterprise Edition**. The **canonical, code-verified capability matrix** is the generated block at the top of this file (source: §0 of [docs/0_strategy_and_roadmap/EDITIONS.md](./docs/0_strategy_and_roadmap/EDITIONS.md) — the master). Where this operational table and the master differ, the master wins.
