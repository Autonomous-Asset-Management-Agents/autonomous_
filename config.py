...
MIN_ORDER_VALUE_USD = float(
    os.getenv("MIN_ORDER_VALUE_USD", "50.0")
)  # #2714: $1 let $1.67-$5 dust through; spread eats any edge below ~$50
...
EXIT_TRAIL_PROFILE = os.getenv("EXIT_TRAIL_PROFILE", "legacy")
...
ROTATION_MAX_EXITS_PER_SESSION = int(os.getenv("ROTATION_MAX_EXITS_PER_SESSION", "3"))
...
SPECIALIST_COVERAGE_DYNAMIC = (
    os.getenv("SPECIALIST_COVERAGE_DYNAMIC", "False").lower() == "true"
)
