...
# RPAR T6a (#1268) data-integrity guard - mirrors config.py, default OFF (dormant).
# When ON the specialist sets the display-only data_quality/degraded fields and may
# skip the non-decision LLM synthesis; OFF = V0 defaults = byte-identical DTO.
DATA_INTEGRITY_GUARD_ENABLED = (
    os.getenv("DATA_INTEGRITY_GUARD_ENABLED", "False").lower() == "true"
)
