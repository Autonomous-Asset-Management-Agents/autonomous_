...
class TestP2AgentWeightZeroExclusion:
    """
    SpecialistAlpha: kein Report → weight=0.0 (nicht 0.55 + score=None)
    NewsSentiment:   Gemini fehlt → weight=0.0 (nicht 0.35 + score=None)
    ...
    def test_consensus_excludes_weight_zero_votes(self):
        ...
        ), f"weight=0.0 Votes ausgeschlossen -> ~0.80 (nur LSTMSignalAgent). Got: {result:.4f}"
