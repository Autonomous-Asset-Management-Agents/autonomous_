...
def test_force_paper_trading_selects_paper_account():
    ...
    try:
        ...
        settings._config_state = config.RuntimeConfigState()
...
def test_config_oss_force_paper_trading_flips_globals():
    ...
    config_oss._config_state.PAPER_TRADING = False
    config_oss._config_state.ALPACA_API_KEY = "LIVE-KEY"
    config_oss._config_state.ALPACA_BASE_URL = "https://api.alpaca.markets"
    ...
    try:
        ...
        assert config_oss._config_state.PAPER_TRADING is True
