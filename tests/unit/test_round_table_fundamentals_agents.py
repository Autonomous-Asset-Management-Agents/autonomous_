...
# ===========================================================================
# 1. DORMANCY — they join the gremium without moving it.
# ===========================================================================
def test_new_modules_are_dormant_at_weight_zero():
    """validate-before-activate: the modules vote and justify, but the consensus
    is unchanged until a walk-forward earns them a weight."""
    assert FundamentalsAgent.default_weight == 0.0
    assert ValuationAgent.default_weight == 0.0
