...
def _build(**env):
    ...
    # Force class defaults to None if they were initialized with real keys
    for key in [
        "ALPACA_API_KEY",
        "ALPACA_SECRET_KEY",
        "ALPACA_LIVE_API_KEY",
        ...
        if key in config.RuntimeConfigState.model_fields:
            config.RuntimeConfigState.model_fields[key].default = None
