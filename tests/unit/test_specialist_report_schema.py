...
def test_default_report_serializes_byte_identical_to_pre_v0_baseline(monkeypatch):
    ...
    monkeypatch.setattr(get_config(), "REPORT_GENERATOR_V2_ENABLED", False)
    monkeypatch.setattr(get_config(), "SPECIALIST_SYNTHESIS_CARD_ENABLED", False)
    r = SpecialistReport(symbol="AAPL")
    dto = _serialize_specialist_report("AAPL", r)
