...
_EXPECTED_DEFAULTS = {
    ...
    # #2839: trailing defaults ON since the desktop-master alignment (was a shell-only
    # injection before; the parity assertion below is what this table is really for).
