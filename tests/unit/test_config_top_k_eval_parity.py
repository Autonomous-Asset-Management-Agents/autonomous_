...
constellation is ACTIVATED: ROUND_TABLE_TOP_K_EVAL defaults to 30 (funnel evaluates the top-30 ranked
names — #2680 "Patient AI", matching the value the desktop already injects via main.cjs) and
ROUND_TABLE_RANK_REFRESH_MINUTES defaults to 120 (rank cache refreshes every 2h) in BOTH editions.
ROUND_TABLE_FUNNEL_MAX_PANEL_AGE_DAYS stays 2 (unchanged). 0 remains reachable via env
