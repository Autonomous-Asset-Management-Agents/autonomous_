...
def _extract_ohlc(snapshot_obj):
    ...
    # #3381 hat den Zeitstempel der Preisquelle als dritten Rueckgabewert ergaenzt.
    # Dieser Test spricht ueber den Preis, nicht ueber sein Alter — das Alter wird
    # in tests/unit/test_quote_age_and_time_budget.py geprueft.
    ohlc, price, _quote_ts = _extract_ohlc_from_snapshot(snapshot_obj)
    return ohlc, price
