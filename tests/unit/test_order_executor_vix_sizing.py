...
def _buy_tenant():
    client = MagicMock()
    acct = MagicMock(cash=100000.0, equity=100000.0, buying_power=100000.0)
    client.get_account = MagicMock(return_value=acct)
    client.get_open_position = MagicMock(return_value=MagicMock(qty="0"))
