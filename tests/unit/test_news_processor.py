...
class TestAnalyzeSentimentsBatchWithModel:
    def test_parses_valid_gemini_response(self, processor_with_model):
        ...
        mock_model.generate_content.return_value = '[{"headline": "AAPL rallies", "sentiment": "positive", "score": 0.9, "reason": "strong earnings"}]'
    ...
    def test_score_clamped_to_minus_one_plus_one(self, processor_with_model):
        proc, mock_model = processor_with_model
        mock_model.generate_content.return_value = '[{"headline": "test", "sentiment": "positive", "score": 5.0, "reason": "extreme"}]'
...
class TestGetHistoricalNews:
    ...
    def test_returns_processed_articles(self, mock_get, processor_no_model):
        ...
        mock_sentiment.generate_content.return_value = '[{"headline": "AAPL hits record", "sentiment": "positive", "score": 0.8, "reason": "surge"}]'
