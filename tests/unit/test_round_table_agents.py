...
class TestSpecialistAlphaAgent:
    ...
    @pytest.mark.anyio
    async def test_dormant_with_report_stays_excluded_and_debug(self, caplog):
        """R6 (#1950): dormant (Default 0.0) + gecachter Report → weight 0.0,
        aus dem Konsens ausgeschlossen, Agent-Log bleibt DEBUG-frei von
        WARNINGs (byte-identisches Ship-Verhalten)."""
        import logging
        ...
        assert SpecialistAlphaAgent.max_weight == 0.0  # dormant module state
