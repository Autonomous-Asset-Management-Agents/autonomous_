...
class TestInitTradingClientsSecretStrSafe:
    ...
    def test_alpaca_clients_receive_plain_strings_not_secretstr(self):
        ...
        with (
            patch(
                "core.engine.api_routes.create_trading_client",  # noqa: E501
                side_effect=mock_trading_client,
            ),
            patch(
                "core.engine.api_routes.create_data_client",
                side_effect=mock_data_client,
            ),
            patch(
                "core.engine.api_routes.BotEngine", return_value=MagicMock()
            ),  # noqa: E501
            ...
            mock_config.ALPACA_API_KEY = SecretStr("TEST_API_KEY")
            mock_config.ALPACA_SECRET_KEY = SecretStr("TEST_SECRET_KEY")
