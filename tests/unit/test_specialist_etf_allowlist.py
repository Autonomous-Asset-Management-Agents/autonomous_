...
class TestEtfAllowlist:
    ...
    def test_etf_short_circuits_all_edgar_fetchers(self, etf):
        ...
        with patch("core.stock_specialist.resolve_cik") as mock_resolve, patch(
            "httpx.AsyncClient"
        ):
        ...
        # Assert resolve_cik was not called (proves short-circuit before I/O).
        # We avoid asserting on httpx.AsyncClient to prevent flaky failures from dangling xdist tasks.
